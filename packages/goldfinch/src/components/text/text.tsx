...
export const GOLDFINCH_TEXT_VARIANTS = {
  variant: {
    heading1: {
    ...
    body: {
      classes: "text-goldfinch-default",
      description: "Default body text",
    },
    secondary: {
      classes: "text-goldfinch-subtle",
      description: "Muted text for secondary information",
    },
    success: {
      classes: "text-goldfinch-link",
      description: "Success state text",
    },
    error: {
      classes: "text-goldfinch-danger",
    ...
    "mono-secondary": {
      classes: "font-mono text-goldfinch-subtle",
...
export const GOLDFINCH_TEXT_DEFAULT_VARIANTS = {
  variant: "body",
  size: "base",
} as const;

/**
 * GOLDFINCH_TEXT_STYLING - Typography metadata for Figma generator
 *
 ...
 */
export const GOLDFINCH_TEXT_STYLING = {
  fontSizes: {
    xs: 12,
    sm: 14,
    base: 16,
  ...
  baseColor: "text-goldfinch-default",
  variantColors: {
    body: "text-goldfinch-default",
    secondary: "text-goldfinch-subtle",
    success: "text-goldfinch-link",
    error: "text-goldfinch-danger",
    mono: "text-goldfinch-default",
    "mono-secondary": "text-goldfinch-subtle",
  },
  fontFamilies: {
    default: "sans-serif",
    mono: "monospace",
...
// Derived types from GOLDFINCH_TEXT_VARIANTS
export type GoldfinchTextVariant = keyof typeof GOLDFINCH_TEXT_VARIANTS.variant;
export type GoldfinchTextSize = keyof typeof GOLDFINCH_TEXT_VARIANTS.size;

export interface GoldfinchTextVariantsProps {
  variant?: GoldfinchTextVariant;
  size?: GoldfinchTextSize;
}

export function textVariants({
  variant = GOLDFINCH_TEXT_DEFAULT_VARIANTS.variant,
  size = GOLDFINCH_TEXT_DEFAULT_VARIANTS.size,
}: GoldfinchTextVariantsProps = {}) {
  return cn(
    resolveVariant(GOLDFINCH_TEXT_VARIANTS.variant, variant, GOLDFINCH_TEXT_DEFAULT_VARIANTS.variant).classes,
    resolveVariant(GOLDFINCH_TEXT_VARIANTS.size, size, GOLDFINCH_TEXT_DEFAULT_VARIANTS.size).classes,
  );
}
...
type TextSize = GoldfinchTextSize;
type TextVariant = GoldfinchTextVariant;
  ...
  return (
    <Component
      ...
      className={cn(
        ...
        resolveVariant(GOLDFINCH_TEXT_VARIANTS.variant, variant, GOLDFINCH_TEXT_DEFAULT_VARIANTS.variant).classes,
        isCopy ? resolveVariant(GOLDFINCH_TEXT_VARIANTS.size, size, GOLDFINCH_TEXT_DEFAULT_VARIANTS.size).classes : "",
        isCopy && bold ? "font-medium" : "",
        // Monospace fonts need to be 1pt smaller than body text to optically match
        isMono &&
          (size === "lg"
            ? GOLDFINCH_TEXT_VARIANTS.size.base.classes
            : GOLDFINCH_TEXT_VARIANTS.size.sm.classes),
