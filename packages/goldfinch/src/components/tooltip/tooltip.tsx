...
export const GOLDFINCH_TOOLTIP_VARIANTS = {
  side: {
    top: {
      classes: "",
...
export const GOLDFINCH_TOOLTIP_DEFAULT_VARIANTS = {
  side: "top",
} as const;

// Derived types from GOLDFINCH_TOOLTIP_VARIANTS
export type GoldfinchTooltipSide = keyof typeof GOLDFINCH_TOOLTIP_VARIANTS.side;

export interface GoldfinchTooltipVariantsProps {
  /**
   ...
   * @default "top"
   */
  side?: GoldfinchTooltipSide;
}

export function tooltipVariants({
  side = GOLDFINCH_TOOLTIP_DEFAULT_VARIANTS.side,
}: GoldfinchTooltipVariantsProps = {}) {
  return cn(
    // Base styles
    "flex origin-[var(--transform-origin)] flex-col rounded-md bg-goldfinch-base px-2.5 py-1.5 text-sm text-goldfinch-default",
    "shadow-lg shadow-goldfinch-tip-shadow outline outline-1 outline-goldfinch-fill",
    ...
    resolveVariant(
      GOLDFINCH_TOOLTIP_VARIANTS.side,
      side,
      GOLDFINCH_TOOLTIP_DEFAULT_VARIANTS.side,
    ).classes,
  );
}
