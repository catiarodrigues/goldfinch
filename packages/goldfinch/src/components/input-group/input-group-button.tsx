...
import { Tooltip, type GoldfinchTooltipSide } from "../tooltip/tooltip";
import type { GoldfinchInputSize } from "../input/input";
import {
  INPUT_GROUP_SIZE,
 ...
 */
const COMPACT_BUTTON_SIZE: Record<GoldfinchInputSize, GoldfinchInputSize> = {
  xs: "xs",
  sm: "xs",
  base: "sm",
  lg: "base",
...
export type InputGroupButtonProps = ButtonProps & {
   ...
   * @default "bottom"
   */
  tooltipSide?: GoldfinchTooltipSide;
};
    ...
    const btn = (
      <ButtonExternal
        ...
        className={cn(
          ...
          !isIndividual &&
            "focus-visible:ring-[1.5px] focus-visible:ring-goldfinch-focus/50",
          ...
          isIndividual && [
            ...
            "relative h-full! rounded-none ring-0 focus-visible:ring-0 border border-goldfinch-line",
            ...
            "focus:z-2",
            "focus-visible:border-goldfinch-focus/50",
            "disabled:bg-goldfinch-overlay disabled:text-goldfinch-inactive!",
          ],
          className,
        )}
      >
