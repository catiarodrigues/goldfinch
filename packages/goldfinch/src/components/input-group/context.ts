...
export const INPUT_GROUP_SIZE: Record<GoldfinchInputSize, InputGroupSizeTokens> = {
  xs: {
    inputOuter: "px-1.5",
...
export const INPUT_GROUP_HAS_CLASSES: Record<GoldfinchInputSize, string> = {
  xs: [
...
export interface InputGroupRootPropsInternal
  extends HTMLAttributes<HTMLElement>,
    Partial<
      ...
      >
    > {
  size?: GoldfinchInputSize | undefined;
  disabled?: boolean;
}
