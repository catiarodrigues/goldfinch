...
export const GOLDFINCH_INPUT_GROUP_VARIANTS = {
  size: {
    xs: {
      classes: "h-6 text-xs",
...
export const GOLDFINCH_INPUT_GROUP_DEFAULT_VARIANTS = {
  size: "base",
} as const;
...
>(
  (
    ...
    const containerClassName = cn(
      ...
      // inputVariants provides base ring-goldfinch-line; must come before state overrides
      inputVariants({ size }),
      ...
      focusMode === "container"
        ? [
            "overflow-hidden",
            // Focus state must come AFTER inputVariants to override ring-goldfinch-line
      ...
      "has-[input[aria-invalid=true]]:ring-goldfinch-danger",
    ...
    // Data attributes drive CSS selectors in goldfinch-binding.css (focus outline)
          ...
          <InputGroupContext.Provider value={containerZoneContext}>
            <div
              ...
              className={cn(
                ...
                "focus-within:border-goldfinch-focus/50",
