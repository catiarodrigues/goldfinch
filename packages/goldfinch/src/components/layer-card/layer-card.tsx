...
export const GOLDFINCH_LAYER_CARD_VARIANTS = {
  // LayerCard currently has no variant options but structure is ready for future additions
} as const;

export const GOLDFINCH_LAYER_CARD_DEFAULT_VARIANTS = {} as const;

// Derived types from GOLDFINCH_LAYER_CARD_VARIANTS
export interface GoldfinchLayerCardVariantsProps {}

export function layerCardVariants(_props: GoldfinchLayerCardVariantsProps = {}) {
 ...
 *   Get started with Goldfinch
 * </LayerCard>
 *
 * <LayerCard>
 *   <LayerCard.Secondary>Next Steps</LayerCard.Secondary>
 *   <LayerCard.Primary>Get started with Goldfinch</LayerCard.Primary>
 * </LayerCard>
 * ```
 */
export type LayerCardProps = useRender.ComponentProps<"div"> &
  GoldfinchLayerCardVariantsProps;
