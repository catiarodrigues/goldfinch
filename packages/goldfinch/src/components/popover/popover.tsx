...
export const GOLDFINCH_POPOVER_VARIANTS = {
  side: {
    top: {
      classes: "",
...
export const GOLDFINCH_POPOVER_DEFAULT_VARIANTS = {
  side: "bottom",
} as const;

// Derived types from GOLDFINCH_POPOVER_VARIANTS
export type GoldfinchPopoverSide = keyof typeof GOLDFINCH_POPOVER_VARIANTS.side;

export interface GoldfinchPopoverVariantsProps {
  /**
...
function PopoverTrigger({
  ...
  return (
    <PopoverBase.Trigger
      data-goldfinch-component="Popover"
 ...
 * ```
 */
export type PopoverContentProps = GoldfinchPopoverVariantsProps & {
  /**
...
function PopoverContent({
  children,
  side = GOLDFINCH_POPOVER_DEFAULT_VARIANTS.side,
  align = "center",
  sideOffset = 8,
  alignOffset = 0,
  ...
  return (
    <PopoverBase.Portal container={container}>
      ...
      >
        <PopoverBase.Popup
          className={cn(
            "flex origin-(--transform-origin) flex-col rounded-lg bg-goldfinch-base px-4 py-3 text-sm text-goldfinch-default",
            "shadow-lg shadow-goldfinch-tip-shadow outline outline-goldfinch-fill",
            "transition-[transform,scale,opacity] duration-150",
            "data-starting-style:scale-90 data-starting-style:opacity-0",
            "data-ending-style:scale-90 data-ending-style:opacity-0",
            "data-instant:duration-0",
            "goldfinch-popover-popup",
            className,
          )}
        >
          <PopoverBase.Arrow
...
function PopoverDescription({ className, ...props }: PopoverDescriptionProps) {
  return (
    <PopoverBase.Description
      className={cn("m-0 text-base leading-6 text-goldfinch-subtle", className)}
      {...props}
    />
  );
}
