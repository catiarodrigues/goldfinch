...
export const GOLDFINCH_SURFACE_VARIANTS = {
  color: {
    primary: {
      classes: "",
...
export const GOLDFINCH_SURFACE_DEFAULT_VARIANTS = {
  color: "primary",
} as const;

// Derived types from GOLDFINCH_SURFACE_VARIANTS
export type GoldfinchSurfaceColor = keyof typeof GOLDFINCH_SURFACE_VARIANTS.color;

export interface GoldfinchSurfaceVariantsProps {
  /**
   ...
   * @default "primary"
   */
  color?: GoldfinchSurfaceColor;
}

export function surfaceVariants({
  color = GOLDFINCH_SURFACE_DEFAULT_VARIANTS.color,
}: GoldfinchSurfaceVariantsProps = {}) {
  return resolveVariant(GOLDFINCH_SURFACE_VARIANTS.color, color, GOLDFINCH_SURFACE_DEFAULT_VARIANTS.color).classes;
}
