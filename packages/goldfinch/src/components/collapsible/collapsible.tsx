...
export const GOLDFINCH_COLLAPSIBLE_VARIANTS = {} as const;

export const GOLDFINCH_COLLAPSIBLE_DEFAULT_VARIANTS = {} as const;

export interface GoldfinchCollapsibleVariantsProps {}

export function collapsibleVariants(_props: GoldfinchCollapsibleVariantsProps = {}) {
  return cn();
}
  ...
  ({ className, ...props }, ref) => {
    return (
      <CollapsibleBase.Trigger
        ref={ref}
        data-goldfinch-component="Collapsible"
 ...
 *
 * Use this for quick migration or when you want the default Goldfinch style.
 *
 * @example
 * ```tsx
 * <Collapsible.Root>
...
>(({ children, className }, ref) => {
  return (
    <CollapsibleBase.Trigger
      ref={ref}
      data-goldfinch-component="Collapsible"
      data-goldfinch-part="default-trigger"
      className={cn(
        ...
        "flex cursor-pointer items-center gap-1 text-sm text-goldfinch-link select-none",
        className,
      )}
    >
      {children}{" "}
...
>(({ children, className, ...props }, ref) => {
  return (
    <CollapsibleBase.Panel
      ref={ref}
      className={cn("my-2 space-y-4 border-l-2 border-goldfinch-fill pl-4", className)}
      {...props}
    >
      {children}
    </CollapsibleBase.Panel>
 ...
 *
 * Use `DefaultTrigger` and `DefaultPanel` for the classic style:
 *
 * ```tsx
 * <Collapsible.Root>
 *   <Collapsible.DefaultTrigger>Show details</Collapsible.DefaultTrigger>
