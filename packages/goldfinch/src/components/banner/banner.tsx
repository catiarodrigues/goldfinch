...
export const GOLDFINCH_BANNER_BASE_STYLES =
...
export const GOLDFINCH_BANNER_VARIANTS = {
  variant: {
    default: {
...
export const GOLDFINCH_BANNER_DEFAULT_VARIANTS = {
  variant: "default",
} as const;

// Derived types from GOLDFINCH_BANNER_VARIANTS
export type GoldfinchBannerVariant = keyof typeof GOLDFINCH_BANNER_VARIANTS.variant;

export interface GoldfinchBannerVariantsProps {
  /**
   ...
   * @default "default"
   */
  variant?: GoldfinchBannerVariant;
}

export function bannerVariants({
  variant = GOLDFINCH_BANNER_DEFAULT_VARIANTS.variant,
}: GoldfinchBannerVariantsProps = {}) {
  const resolvedVariant = resolveVariant(
    GOLDFINCH_BANNER_VARIANTS.variant,
    variant,
    GOLDFINCH_BANNER_DEFAULT_VARIANTS.variant,
  );

  return cn(
    // Base styles (exported as GOLDFINCH_BANNER_BASE_STYLES for Figma plugin)
    GOLDFINCH_BANNER_BASE_STYLES,
    // Apply variant styles from GOLDFINCH_BANNER_VARIANTS
