...
export const GOLDFINCH_SIDEBAR_VARIANTS = {
  variant: {
    sidebar: {
      classes: "",
...
export const GOLDFINCH_SIDEBAR_DEFAULT_VARIANTS = {
  variant: "sidebar",
  collapsible: "icon",
  side: "left",
} as const;

export const GOLDFINCH_SIDEBAR_STYLING = {
  width: {
    expanded: "16.25rem",
    icon: "57px",
  },
...
function SidebarProvider({
  ...
  variant = GOLDFINCH_SIDEBAR_DEFAULT_VARIANTS.variant,
  side = GOLDFINCH_SIDEBAR_DEFAULT_VARIANTS.side,
  collapsible = GOLDFINCH_SIDEBAR_DEFAULT_VARIANTS.collapsible,
  resizable = false,
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper relative isolate flex w-full [--sidebar-bg:var(--color-goldfinch-base)] [--sidebar-active-bg:var(--color-goldfinch-tint)]",
          !contained && !isMobile && "min-h-svh",
          "has-data-[variant=inset]:bg-goldfinch-recessed",
    ...
    if (collapsible === "none") {
      return (
        <aside
          ...
          className={cn(
            "relative flex h-full shrink-0 grow-0 flex-col overflow-hidden bg-(--sidebar-bg) text-goldfinch-default",
            variant === "sidebar" &&
              (side === "left"
                ? "border-r border-goldfinch-line"
                : "border-l border-goldfinch-line"),
            variant === "floating" &&
              "m-2 rounded-lg border border-goldfinch-line shadow-lg",
            className,
          )}
          {...props}
        >
      ...
      return (
        <>
          ...
          <div
            ...
            className={cn(
              contained ? "absolute inset-0 z-40 bg-goldfinch-recessed" : "fixed inset-0 z-40 bg-goldfinch-recessed",
          ...
          <nav
            ...
            className={cn(
              ...
              "border-r border-goldfinch-line bg-(--sidebar-bg) text-goldfinch-default",
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  "bg-(--sidebar-bg) text-goldfinch-default",
                  borderClasses,
                  "transition-[width] duration-(--sidebar-animation-duration) ease-(--sidebar-easing)",
                  "motion-reduce:transition-none",
                  isResizing && "transition-none!",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="header"
    className={cn(
      "flex h-[58px] shrink-0 items-center gap-1 border-b border-goldfinch-line",
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    >
      <ScrollAreaBase.Thumb className="flex-1 rounded-full bg-goldfinch-line" />
    </ScrollAreaBase.Scrollbar>
  </ScrollAreaBase.Root>
));
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="footer"
    className={cn(
      "flex h-12 shrink-0 items-center gap-4 overflow-hidden whitespace-nowrap border-t border-goldfinch-line",
      ...
      "group-data-[state=collapsed]/sidebar:border-r group-data-[state=collapsed]/sidebar:border-goldfinch-line",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "grid-rows-[0fr] my-3 border-b border-goldfinch-line",
  ...
  >
    <div className="min-h-0 min-w-0">
      <div
        className={cn(
          "truncate px-3 mt-4 mb-2 text-sm font-medium text-goldfinch-subtle",
...
const SidebarMenuButton = forwardRef<HTMLButtonElement, SidebarMenuButtonProps>(
  (
    ...
    const buttonClasses = cn(
      ...
      // Focus
      "focus:outline-none focus-visible:text-goldfinch-strong focus-visible:bg-(--sidebar-active-bg)",
      className,
    );
    ...
    if (href) {
      button = (
        <LinkComponent
          ...
          data-goldfinch-component="Sidebar"
          data-goldfinch-part="menu-button-link"
          data-size={size}
          onClick={
      ...
      button = (
        <button
          ...
          data-sidebar="menu-button"
          data-goldfinch-component="Sidebar"
          data-goldfinch-part="menu-button"
          data-size={size}
          {...props}
        >
          {content}
...
>(({ className, ...props }, ref) => (
  <span
    ...
    className={cn(
      "inline-flex shrink-0 items-center rounded-full border border-dashed border-goldfinch-line",
      "select-none px-1.5 py-0.5 text-[11px]/none font-medium text-goldfinch-strong",
...
>(({ className, children, ...props }, ref) => (
  <ul
    ...
    {...props}
  >
    <div className="absolute left-[19px] inset-y-px w-px bg-goldfinch-line z-10" />
    {children}
  </ul>
));
...
>(({ className, active = false, href, children, ...props }, ref) => {
  ...
  const buttonClasses = cn(
    ...
    "before:absolute before:inset-x-0 before:-inset-y-px",
    "text-goldfinch-default transition-[color] duration-150",
    !active && "hover:bg-(--sidebar-active-bg)",
    active && "bg-(--sidebar-active-bg)",
    "focus:outline-none focus-visible:text-goldfinch-strong focus-visible:bg-(--sidebar-active-bg)",
    className,
  ...
  if (href) {
    button = (
      <LinkComponent
        ...
        data-goldfinch-component="Sidebar"
        data-goldfinch-part="menu-sub-button-link"
        onClick={
          props.onClick as unknown as React.MouseEventHandler<HTMLAnchorElement>
        }
      >
    ...
    button = (
      <button
        ...
        data-sidebar="menu-sub-button"
        data-goldfinch-component="Sidebar"
        data-goldfinch-part="menu-sub-button"
        {...props}
      >
        {content}
      </button>
...
>(({ className, ...props }, ref) => (
  <div
    ...
    {...props}
  >
    <div className="border-b border-goldfinch-line" />
  </div>
));
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "text-goldfinch-subtle hover:text-goldfinch-default hover:bg-(--sidebar-active-bg)",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-goldfinch-brand",
        className,
      )}
      onClick={(e) => {
        onClick?.(e);
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:after:bg-goldfinch-brand/20",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:after:bg-goldfinch-hairline active:after:bg-goldfinch-hairline focus-visible:after:bg-goldfinch-hairline",
        "focus:outline-none",
