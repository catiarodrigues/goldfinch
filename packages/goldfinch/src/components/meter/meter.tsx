...
export const GOLDFINCH_METER_VARIANTS = {
  // Meter currently has no variant options but structure is ready for future additions
} as const;

export const GOLDFINCH_METER_DEFAULT_VARIANTS = {} as const;

// Derived types from GOLDFINCH_METER_VARIANTS
export interface GoldfinchMeterVariantsProps {}

export function meterVariants(_props: GoldfinchMeterVariantsProps = {}) {
  return cn(
    // Base styles
 ...
 * ```
 */
export interface MeterProps extends RootProps, GoldfinchMeterVariantsProps {
