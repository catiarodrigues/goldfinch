...
export const GOLDFINCH_CLIPBOARD_TEXT_VARIANTS = {
  size: {
    sm: {
      classes: "text-xs",
...
export const GOLDFINCH_CLIPBOARD_TEXT_DEFAULT_VARIANTS = {
  size: "lg",
} as const;
...
// Derived types from GOLDFINCH_CLIPBOARD_TEXT_VARIANTS
export type GoldfinchClipboardTextSize =
  keyof typeof GOLDFINCH_CLIPBOARD_TEXT_VARIANTS.size;

export interface GoldfinchClipboardTextVariantsProps {
  /**
   ...
   * @default "lg"
   */
  size?: GoldfinchClipboardTextSize;
}

export function clipboardTextVariants({
  size = GOLDFINCH_CLIPBOARD_TEXT_DEFAULT_VARIANTS.size,
}: GoldfinchClipboardTextVariantsProps = {}) {
  return cn(
    // Base styles
    "flex items-center overflow-hidden bg-goldfinch-base px-0 font-mono",
    // Apply size styles from GOLDFINCH_CLIPBOARD_TEXT_VARIANTS
    resolveVariant(GOLDFINCH_CLIPBOARD_TEXT_VARIANTS.size, size, GOLDFINCH_CLIPBOARD_TEXT_DEFAULT_VARIANTS.size).classes,
  );
}

// Legacy type alias for backwards compatibility
export type ClipboardTextSize = GoldfinchClipboardTextSize;
 ...
 * <ClipboardText text="npm install @catiarodrigues/goldfinch" size="sm" />
 * ```
 */
export interface ClipboardTextProps extends GoldfinchClipboardTextVariantsProps {
...
export const ClipboardText = forwardRef<HTMLDivElement, ClipboardTextProps>(
  (
    ...
    const sizeConfig = resolveVariant(GOLDFINCH_CLIPBOARD_TEXT_VARIANTS.size, size, GOLDFINCH_CLIPBOARD_TEXT_DEFAULT_VARIANTS.size);
