...
export const GOLDFINCH_DROPDOWN_VARIANTS = {
  variant: {
    default: {
      classes: "",
    ...
    danger: {
      classes:
        "text-goldfinch-danger data-highlighted:bg-goldfinch-danger/5 data-highlighted:text-goldfinch-danger",
      description: "Destructive action item",
    },
  },
} as const;

export const GOLDFINCH_DROPDOWN_DEFAULT_VARIANTS = {
  variant: "default",
} as const;

// Derived types from GOLDFINCH_DROPDOWN_VARIANTS
export type GoldfinchDropdownVariant = keyof typeof GOLDFINCH_DROPDOWN_VARIANTS.variant;

export interface GoldfinchDropdownVariantsProps {
  /**
   ...
   * @default "default"
   */
  variant?: GoldfinchDropdownVariant;
}

export function dropdownVariants({
  variant = GOLDFINCH_DROPDOWN_DEFAULT_VARIANTS.variant,
}: GoldfinchDropdownVariantsProps = {}) {
  return cn(resolveVariant(GOLDFINCH_DROPDOWN_VARIANTS.variant, variant, GOLDFINCH_DROPDOWN_DEFAULT_VARIANTS.variant).classes);
}
...
>(({ className, inset, children, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.SubmenuTrigger
    ref={ref}
    data-goldfinch-component="DropdownMenu"
    data-goldfinch-part="submenu-trigger"
    className={cn(
      "flex cursor-default items-center rounded-sm text-base outline-hidden select-none", // base styles
      "px-2 py-1.5", // spacing
      "focus:bg-goldfinch-tint focus:ring-goldfinch-focus/50 focus-visible:ring-2 focus-visible:ring-goldfinch-brand", // focus state
      "data-[state=open]:bg-goldfinch-tint", // open state
      ...
      <DropdownMenuPrimitive.Portal container={container}>
        ...
        >
          <DropdownMenuPrimitive.Popup
            className={cn(
              "overflow-hidden bg-goldfinch-control text-goldfinch-default", // background
  ...
  (
    ...
    return (
      <DropdownMenuPrimitive.LinkItem
        ref={ref}
        data-goldfinch-component="DropdownMenu"
        data-goldfinch-part="link-item"
        className={cn(
          "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none",
          "focus:text-goldfinch-default focus:ring-goldfinch-focus/50 focus-visible:ring-2 focus-visible:ring-goldfinch-brand data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-goldfinch-overlay",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    data-goldfinch-component="DropdownMenu"
    data-goldfinch-part="checkbox-item"
    className={cn(
      "relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-base outline-hidden transition-colors select-none focus:bg-goldfinch-tint focus:text-goldfinch-default focus:ring-goldfinch-focus/50 focus-visible:ring-2 focus-visible:ring-goldfinch-brand data-disabled:pointer-events-none data-disabled:opacity-50",
      className,
    )}
    checked={checked}
    {...props}
...
>(({ className, children, inset, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    data-goldfinch-component="DropdownMenu"
    data-goldfinch-part="radio-item"
    className={cn(
      "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none",
      "data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-goldfinch-tint",
      inset && "pl-8",
      className,
    )}
    {...props}
